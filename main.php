...
<html>
<head>
	<title>Artists Portal login and signup</title>
	<meta charset="utf-8">
...
<body>
	<div class="row">
		<div class="col-sm-12">
			<div class="well">
				<center><h1 style="color: white;">Artists Portal</h1></center>
			</div>
		</div>
	</div>
	<div class="row">
		...
		<div class="col-sm-6" style="left:8%:">
			...
			<h2><strong>Meet Artists around <br> the world</strong></h2><br><br>
			<h4><strong>join Artists Portal Today.</strong></h4>
